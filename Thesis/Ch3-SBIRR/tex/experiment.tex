...
\subsection{Baselines.} We compare to three other methods, all described in \cref{sec:intro}. (1) A vanilla multimarginal SB (\textit{\vanilla{}}) with a Brownian motion reference. See \cref{sec:vanilla-app} for implementation details.
