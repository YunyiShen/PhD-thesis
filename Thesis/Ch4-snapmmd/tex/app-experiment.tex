...
\input{Ch4-snapmmd/tables/summary_combined_emd}
...
\input{Ch4-snapmmd/tables/summary_interpolation_mmd}

\input{Ch4-snapmmd/tables/summary_interpolation_emd}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/LV_appendix_diff_arrows.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/LV_interpolationing.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/LV_classic_interpolation_metric.pdf}
    \caption{LV interpolation metrics}
    \label{fig:lv-metrics-interpol}
\end{figure}


\input{Ch4-snapmmd/tables/LV_classic_MMD}

\input{Ch4-snapmmd/tables/LV_classic_EMD}
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/Repressilator_forecasting.pdf}
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/Repressilator_appendix_diff_arrows.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/Repressilator_interpolationing.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/Repressilator_classic_interpolation_metric.pdf}
    \caption{Parametric interpolation metric}
    \label{fig:repr-metric-interpol}
\end{figure}

\input{Ch4-snapmmd/tables/Repressilator_classic_MMD}

\input{Ch4-snapmmd/tables/Repressilator_classic_EMD}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/mlp_Repressilator_appendix_diff_arrows.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/mlp_Repressilator_interpolationing.png}
...
\begin{figure}
    ...
    \includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/Repressilator_mlp_interpolation_metric.pdf}
...
\input{Ch4-snapmmd/tables/Repressilator_mlp_MMD}

\input{Ch4-snapmmd/tables/Repressilator_mlp_EMD}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/missingobs_Repressilator_interpolationing}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/Repressilator_missingobs_interpolation_metric.pdf}
...
\input{Ch4-snapmmd/tables/Repressilator_missingobs_MMD}

\input{Ch4-snapmmd/tables/Repressilator_missingobs_EMD}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/GoM_appendix_diff_arrows.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/GoM_interpolationing.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/GoM_realdata_interpolation_metric.pdf}
    \caption{Metrics for Interpolation of Gulf of Mexico current.}
    \label{fig:GoM-interpol-metric}
\end{figure}

\input{Ch4-snapmmd/tables/GoM_realdata_MMD}

\input{Ch4-snapmmd/tables/GoM_realdata_EMD}
...
\begin{figure}
    \centering
    \includegraphics[width=.85\linewidth]{Ch4-snapmmd/Figs/pbmc_forecasting_progression_6x4.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/pbmc_interpolationing.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=.85\linewidth]{Ch4-snapmmd/Figs/pbmc_interpolation_grid_1.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=.85\linewidth]{Ch4-snapmmd/Figs/pbmc_interpolation_grid_2.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=.85\linewidth]{Ch4-snapmmd/Figs/pbmc_interpolation_grid_3.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=.85\linewidth]{Ch4-snapmmd/Figs/pbmc_interpolation_grid_4.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/pbmc_realdata_interpolation_metric.pdf}
    \caption{Metrics for Interpolation of pbmc dataset. }
    \label{fig:pbmc-interpol-metric}
\end{figure}

\input{Ch4-snapmmd/tables/pbmc_realdata_MMD}
