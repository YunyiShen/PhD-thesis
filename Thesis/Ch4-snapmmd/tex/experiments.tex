...
\begin{figure}[t!]
    \centering
    \includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/mlp_Repressilator_forecasting.pdf}
    \includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/missingobs_Repressilator_forecasting.pdf}
    \vspace{-0.6cm}
...
\begin{figure}[!t]
    \centering
\includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/GoM_forecasting.pdf}
    \vspace{-0.6cm}
...
\begin{figure}[!t] \centering \includegraphics[width=\linewidth]{Ch4-snapmmd/Figs/pbmc_forecasting_maintext.pdf} 
\vspace{-0.5cm}
