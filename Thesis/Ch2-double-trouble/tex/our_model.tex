...
\revision{A rough intuition for our choice of $\ratemeasproposed$ is that first, we wish to retain a product of beta distributions to ensure conjugacy.
...
we need to choose the leading factor in a way that satisfies \cref{req:finite_mean,req:inf_mass} and also allows desirable power law growth properties (\cref{sec:powerlaw}). We describe how we arrived at the particular choice of $\ratemeasproposed$ in more detail in S2.2 in \internal{the} Supplementary Material \citep{supplement}}.
...
\begin{figure}
    \centering
    \includegraphics[width = \linewidth]{Figs/rate_measures_near_cojugate.png}
...
see Section S2 of the Supplementary Material \citep{supplement} for a proof. \minorrevision{An interesting line of investigation for future work would be to establish hyperparameter ranges that are both sufficient and necessary.}
