...
%
For each population (lung cancer, breast cancer) in each dataset (TCGA, MSK-IMPACT), we find that the best-performing one-population method is the 3BP (\cref{sec:single_pop_methods}). So we compare to the independent and dependent one-population applications of the 3BP in this analysis.



\begin{figure}[htp]
    \centering
    \includegraphics[width = 0.9\textwidth]{Ch2-double-trouble/Figs//BIDC_LA2_20fold.png}
    \includegraphics[width = 0.9\textwidth]{Ch2-double-trouble/Figs//BRCA_LUAD_20fold.png}
...
\begin{figure}[htp]
    \centering
    \includegraphics[width = 0.9\textwidth]{Ch2-double-trouble/Figs//kor_bgr_30fold.png}
    \includegraphics[width = 0.9\textwidth]{Ch2-double-trouble/Figs//seu_bgr_30fold.png}
