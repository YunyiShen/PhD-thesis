...
We next define \emph{our proposed distribution} over measures. The prior that we use for our model in the main text is the special case with zero fixed atoms. 
