...
In our plots, as in the main text, we use the \emph{relative residual} as a measure of accuracy. Namely, the signed difference between a method’s prediction and the observed value in the reserved follow-up data, normalized by the observed value.
...
\begin{figure}[htp]
    \centering
    \includegraphics[width = 0.9\textwidth]{Figs/i3BP_20fold.png}
    \includegraphics[width = 0.9\textwidth]{Figs/i3BP_slow_20fold.png}
...
\begin{figure}[htp]
    \centering
    \includegraphics[width = 0.9\textwidth]{Figs/d3BP_20fold.png}
    \includegraphics[width = 0.9\textwidth]{Figs/d3BP.1_20fold.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.6\textwidth]{Figs/BIDC_LA2_20fold_one_pop.png}
    \includegraphics[width = 0.6\textwidth]{Figs/BRCA_LUAD_20fold_one_pop.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.9\textwidth]{Figs/Gnomad_one_pop_combined.png}
...
In this section, unlike in the main text and in \cref{sec:single_pop_methods}, we report the raw number of shared variants and the raw magnitude of residuals (difference between predicted and true). Our findings when using this raw measure are similar to the ones obtained when using normalized residuals: our proposed methods performs well overall. 
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.9\textwidth]{Figs/n3bp_20fold_kton_res.png}
    \includegraphics[width = 0.9\textwidth]{Figs/n3BP_fast_20fold_kton_res.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.9\textwidth]{Figs/i3BP_20fold_kton_res.png}
    \includegraphics[width = 0.9\textwidth]{Figs/i3BP_slow_20fold_kton_res.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.9\textwidth]{Figs/d3BP_20fold_kton_res.png}
    \includegraphics[width = 0.9\textwidth]{Figs/d3BP.1_20fold_kton_res.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.9\textwidth]{Figs/BIDC_LA2_20fold_kton_res.png}
    \includegraphics[width = 0.9\textwidth]{Figs/BRCA_LUAD_20fold_kton_res.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.9\textwidth]{Figs/kor_bgr_30fold_kton_res.png}
    \includegraphics[width = 0.9\textwidth]{Figs/seu_bgr_30fold_kton_res.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.9\textwidth]{Figs/n3bp_slow_20fold.png}
    \includegraphics[width = 0.9\textwidth]{Figs/d3bp.3_20fold.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.9\textwidth]{Figs/kor_bgr_30fold_trim15.png}
    \includegraphics[width = 0.9\textwidth]{Figs/seu_bgr_30fold_trim15.png}
    \caption{Prediction for the GnomAD dataset, Korean--Bulgarian and Southern European--Bulgarian respectively. The trimming here is set to 15. The results are the same as trimming at 10 in the main text Figure 5.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.9\textwidth]{Figs/seu_bgr_30fold_trim20.png}
    \caption{Prediction for the GnomAD dataset Southern European--Bulgarian respectively. The trimming here is set to 20. The results are the same as trimming at 10 in the main text Figure 5. The Korean population does not have enough training samples to allow a trimming of 20.}
    \label{fig:seu_bgr_20}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width = 0.9\textwidth]{Figs/BIDC_LA2_20fold_trim15.png}
    \caption{Prediction for the variant counts in, breast and lung cancer. For  MSK-IMPACT dataset. This experiment used trimming of 15 during training. The results are the same as trimming at 10 in the main text Figure 4.}
